...
MODEL_PATH="checkpoints/Qwen2-VL-2B-Instruct" # Qwen2vl-2b-Instruct for original scores
BSZ=16 # reduce it if GPU OOM
OUTPUT_PATH="src/eval/logs/counting_results_superclevr_200_qwen2vl_2b_instruct.json"
PROMPT_PATH="src/eval/prompts/superclevr_test200_counting_problems.jsonl"
